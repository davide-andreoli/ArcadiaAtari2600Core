//
//  Atari2600Core.swift
//  ArcadiaAtari2600Core
//
//  Created by Davide Andreoli on 16/07/24.
//

import Foundation
import ArcadiaCore

@Observable public class ArcadiaAtari2600: ArcadiaCoreProtocol {
    
    public typealias ArcadiaCoreType = ArcadiaAtari2600
